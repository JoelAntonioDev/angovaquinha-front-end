        ...
        if (userDetails) {
            ...
            fetch(`http://localhost:8080/api/edit-user/${userDetails.id}`, {
                ...
                .then(data => {
                    ...
                    setUsuarios((prevUsuarios) => prevUsuarios.map(u => (u.id === data.data.id ? data.data : u)));
    ...
    return (
        <div className="p-d-flex p-flex-column p-ai-center">
            ...
            <div className="p-mt-4">
                <DataTable value={usuarios} paginator rows={10} className="p-datatable-customers">
                    ...
                    <div className="p-mt-4">
                        ...
                        {infoContato ? (
                            editMode ? (
                                ...
                                <div>
                                    <p><strong>Bilhete de Identidade:</strong> {infoContato.bilheteIdentidade}</p>
                                    <p><strong>Número de Telefone:</strong> {infoContato.numeroTelefone}</p>
                                    <p><strong>Província:</strong> {infoContato.provincia}</p>
                                    <p><strong>Município:</strong> {infoContato.municipio}</p>
                                    <div className="p-d-flex p-ai-center">
                                        <Button
                                            label="Editar"
                                            icon="pi pi-pencil"
